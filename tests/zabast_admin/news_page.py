...
from tests.zabast_admin.locators import NewsPageLocators
...
class NewsPage(BasePage):
    ...
    def create_news(self):
        ...
        date_area.send_keys("10-01-2020")
        ...
        title_area.send_keys("What is Lorem Ipsum?")
        time.sleep(2)
        ...
        content_area.send_keys("Здесь текст новости")
        time.sleep(2)
        ...
        link_area.send_keys("https://www.lipsum.com/feed/html")
        time.sleep(2)
        ...
        tag_area.send_keys("here")
        tag_area.send_keys(Keys.RETURN)
        tag_area.send_keys("here2")
        tag_area.send_keys(Keys.RETURN)
        time.sleep(3)
        ...
        # photo.send_keys("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4TIynVSA4JKpyRQX0aRdDFxTWjJQO1PojWBHQkE7jnI1Iv83Www&s")
